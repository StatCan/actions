...
class Client(object):
  ...
  def __init__(self, host=None, namespace='kubeflow'):
    ...
    config = self._load_config(host, namespace)
    api_client = kfp_server_api.api_client.ApiClient(config, 'X-Auth-Token', os.environ["INPUT_X_AUTH_TOKEN"])
  ...
  def _load_config(self, host, namespace):
